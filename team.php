...
<div class="site">
    ...
    <div class="box" style="margin: 3%; width: 80%; justify-items: center;">
        <p style="margin: 0; font-size: 22px; text-align: center">
            ...
            Al momento il team è composto da un solo membro attivo.
        </p>
    </div>

    <div class="box" style="margin: 3%; width: 50%; justify-items: center;">
        <p style="margin: 0; font-size: 22px; text-align: center">
            Christopher - Fondatore e sviluppatore <br> <br>
            Sviluppatore e gestore principale del progetto.
            Si occupa di programmazione, sistemi Linux e sviluppo software,
            con focus su progetti sperimentali e crescita continua.
        </p>
    </div>
